...
; CAN ALSO DIRECTLY MULTIPLY WITH A VARIABLE RATHER THAN STORING ITS VALUE IN A REGISTER
...
; -> OTHER OPERAND CAN BE STORED IN ANY OTHER 16 BIT REGISTER / MEMORY LOCATION
